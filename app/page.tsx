    ...
    <>
      ...
      <PageShell>
        <section className="hero">
          <Image className={styles.heroPolarBackdrop} src="/brand/polar-activated.png" alt="" fill priority sizes="100vw" />
        ...
        <section className={styles.polarDirective}>
          <div className={styles.directiveImage}><Image src="/brand/polar-primary.png" alt="P.O.L.A.R. enterprise intelligence companion" fill sizes="(max-width: 900px) 100vw, 45vw" /></div>
        ...
        <section className={styles.polarField}><Image src="/brand/polar-primary.png" alt="" fill sizes="100vw" /><div><p className="eyebrow">P.O.L.A.R. TRANSMISSION</p><h2>YOUR IDEA IS NOT TOO COMPLICATED.<br /><em>IT IS WAITING FOR ARCHITECTURE.</em></h2></div></section>
