...
const officialAssets = [
  ...
  ["07_off_the_wall_concept.png", "OFF THE WALL // OUT OF THE BOX", true, false],
  ...
  ["BI_POLARIZE_Assets_Contact_Sheet.png", "OFFICIAL ASSET SYSTEM // MASTER CONTACT SHEET", true, true],
] as const;
    ...
    <PageShell>
      ...
      <section className="section-shell why-section" id="why">
        ...
        <div className="declaration-grid">
          <div className="declaration-copy">
            ...
            <p className="declaration-punch">The goal is not to make unconventional founders conventional. The goal is to make their vision functional.</p>
          </div>
          <aside className="founder-aside">
            <div className="founder-frame"><Image src="/founder.jpg" alt="Founder and Director of Operations" fill sizes="(max-width: 900px) 90vw, 32vw" /></div>
      ...
      <section className="brand-gallery-section">
        <div className="section-shell">
          <div className="section-index">CORPORATE IDENTITY // OFFICIAL ASSET SYSTEM</div>
          <div className="brand-gallery-head">
            <div><p className="eyebrow">THE UPDATED SYSTEM, MADE VISIBLE</p><h2>ONE IDENTITY.<br /><em>EVERY ENVIRONMENT.</em></h2></div>
            <p>The complete approved BI POLARIZE identity is deployed here—from official marks and P.O.L.A.R. interfaces to physical and digital applications.</p>
          </div>
          <div className="brand-gallery">
            {officialAssets.map(([file, label, wide, contain]) => (
              <figure key={file} className={`${wide ? "brand-gallery-wide " : ""}${contain ? "brand-gallery-contain" : ""}`}>
                <Image src={`/brand/official/${file}`} alt={`BI POLARIZE ${label.toLowerCase()}`} fill sizes={wide ? "100vw" : "(max-width: 900px) 100vw, 50vw"} />
        ...
        <div className="section-shell">
          ...
          <div className="declaration-grid">
            ...
            <aside className="founder-aside">
              ...
              <div className="founder-bio"><small>FOUNDER // DIRECTOR OF OPERATIONS</small><h3>Architect of the Bipolarization Method</h3><p>A multidisciplinary business architect, researcher, creative producer, and unconventional problem-solver based in Ogden, Utah.</p><p>With a B.S. in Audio Production, an A.S. in Business, and multiple business-management certifications, the Founder combines formal education with lived experience, spiritual intelligence, creative instinct, strategic research, and streetwise execution.</p></div>
            </aside>
          </div>
        </div>
      </section>
